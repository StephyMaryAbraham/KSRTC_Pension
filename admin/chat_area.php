...
<div class="container-fluid <?php if($chat['chat_type']=='master'){?>darker<?php }  ?> chat">
  
  <p><?php echo $chat['chat_content']; ?></p>
  <span class="<?php if($chat['chat_type']=='master'){?>time-left<?php }else { ?>time-right <?php } ?>"><?php if($chat['chat_type']=='master'){ echo $station_master['sm_name']; }else { echo "me"; } ?></span>
</div>
