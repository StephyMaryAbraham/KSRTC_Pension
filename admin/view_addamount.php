		 ...
		 <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="">
                            <h2>
                                 Amount added to Corporation fund
                            </h2>
                        </div>
...
$x=1;
       ...
       $query = $connection->prepare("SELECT * FROM `station_amount` join station on station_amount.sa_station_id=station.station_id join station_master on station_amount.sa_station_id=station_master.sm_station_id where station_amount.sa_status=1");
