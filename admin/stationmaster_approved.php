...
<table id="example" class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            <th colspan="12" style="background-color:#6495ED;text-align:center;">APPROVED STATION MASTERS</th>
...
$x=1;
       ...
       $query = $connection->prepare("SELECT * FROM `station_master` join station on station_master.sm_station_id=station.station_id where station_master.sm_status=1");
  ...
  while($sm=$query->fetch(PDO::FETCH_ASSOC)){
        ?>
         ...
         <!-- <form method="post">
            ...
            <td style="text-align:center;"><input type="submit" class="btn btn-info" name="approve" value="Approve"></td>
