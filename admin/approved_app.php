...
$x=1;
       ...
       $query = $connection->prepare("SELECT * FROM `pensioner` join `station` on pensioner.penr_station_id=station.station_id join `pension_details` on pensioner.penr_id=pension_details.pensioner_id where pension_details.pension_status=1");
